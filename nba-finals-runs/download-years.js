...
// var q = queue(1)
// finalsTeams.forEach(d => q.defer(downloadYear, d))
// q.awaitAll(err => console.log(err, 'Team Queue Done'))

// // console.log(finalsTeams)

// function downloadYear(slug, cb){
//   // console.log(slug)

//   var [teamID, year] = slug.split('_')
//   var url = `http://stats.nba.com/stats/teamgamelog?LeagueID=00&Season=${year}&SeasonType=Playoffs&TeamID=${teamID}`

//   request({url, headers: nba.headers}, (err, res) => {
//     if (err) throw err
//     fs.writeFileSync(__dirname + '/raw-years/' + slug + '.json', res.body)
